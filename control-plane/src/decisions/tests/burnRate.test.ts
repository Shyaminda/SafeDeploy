...
describe("evaluateBurnRate", () => {
  ...
  it("detects fast burn at boundary (burnRate slightly above 2)", () => {
    const severity = evaluateBurnRate(2.01, 0.5);
    expect(severity).toBe("fast-burn");
  });
