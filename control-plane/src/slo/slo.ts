...
export const DEMO_APP_SLOS: SLO[] = [
	{
		...
		windowDays: 30,
		rationale: "Below 99.9% success rate, users experience frequent errors and trust degrades. This SLO ensures we maintain a high level of reliability and user satisfaction."
	},
	{
		...
		windowDays: 30,
		rationale: "Latency above 300ms is perceived as slowness for synchronous APIs."
	}
];